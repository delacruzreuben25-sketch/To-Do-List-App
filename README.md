...
Detailed System Flow:
   ...
   1. Adding a Task: You type a new task (e.g., "Buy bread").
   ...
   4. Deletion: If you swipe to delete, the app tells the server to remove that entry from the database forever.
